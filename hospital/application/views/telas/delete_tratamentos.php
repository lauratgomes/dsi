<?php
    if ($this->session->userdata('logado') == true) {
        ...
        echo form_input(array('name'=>'cpf_paciente'), set_value('cpf_paciente', $query->cpf_paciente), 'disabled="disabled"');
        echo "<br />";
        echo form_label('CPF do médico: ');
        echo form_input(array('name'=>'cpf_medico'), set_value('cpf_medico', $query->cpf_medico), 'disabled="disabled"');
        echo "<br />";
        echo form_label('CID: ');
        echo form_input(array('name'=>'cid'), set_value('cid', $query->cid), 'disabled="disabled"');
        echo "<br />";
        echo form_label('Remédio: ');
        echo form_input(array('name'=>'remedio'), set_value('remedio', $query->remedio), 'disabled="disabled"');
        echo "<br />";
